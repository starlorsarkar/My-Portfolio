...
// 6 pinned projects — exact GitHub repo names
const PINNED = [
...
const DESCRIPTIONS = {
  'customer-churn-prediction-using-ann': 'Built an Artificial Neural Network to predict customer churn for a bank. Performed feature engineering, data preprocessing, and model evaluation to identify at-risk customers and support retention strategy decisions.',
  'diwali-sales-analysis':               'Analysed Diwali season sales data to uncover purchasing patterns across demographics, regions, and product categories. Used Python and Seaborn to visualise trends and surface actionable retail insights.',
  'walmart-project':                     'Explored Walmart transactional data to identify sales trends, high-performing categories, and regional performance. Applied EDA techniques in Python to deliver business-ready insights for retail decision-making.',
  'image-classification-using-ann':      'Developed an Artificial Neural Network to classify images across multiple categories. Implemented data preprocessing, model training, and performance evaluation using Python and deep learning frameworks.',
  'musicstore-analysis':                 'Conducted a deep SQL-based analysis of a digital music store database. Used complex joins, subqueries, and window functions to surface top artists, customer spending patterns, and genre popularity insights.',
  'weather-analysis':                    'Analysed historical weather data to identify climate patterns, seasonal trends, and anomalies. Used Python and visualisation libraries to surface actionable insights from temperature, humidity, and precipitation records.',
};
